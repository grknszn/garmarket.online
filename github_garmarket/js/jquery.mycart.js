    ...
    var loadMyCartEvent = function (targetSelector) {
        ...
        if (!$("#" + idCartModal).length) {
            $('body').append(
                ...
                '<h4 class="modal-title" id="myModalLabel"><span class="fas fa-shopping-cart"></span> Sepetim </h4>' +
                '</div>' +
                ...
                '<button type="button" class="btn btn-primary ' + classCheckoutCart + '">Sipariş ver</button>' +
                '</div>' +
                '</div>' +
                '</div>' +
                '</div>'
        ...
        var drawTable = function () {
            ...
            $.each(products, function () {
                ...
                $cartTable.append(
                    ...
                    '<td title="Sepetten çıkar" class="text-center" style="width: 30px;"><a href="javascript:void(0);" class="btn btn-xs btn-danger ' + classProductRemove + '">X</a></td>' +
                    '</tr>'
                );
            });
